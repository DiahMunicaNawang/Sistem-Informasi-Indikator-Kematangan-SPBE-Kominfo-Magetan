<div class="modal fade" id="detailIndikatorModal" tabindex="-1" aria-labelledby="detailIndikatorModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
                        ...
                        <div class="mb-5 card card-bordered flex-grow-1">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3 d-flex flex-column">
                                    ...
                                    <div>
                                        <a href="#" id="detailDocumentation" target="_blank" class="btn btn-sm btn-light-danger">
                                            Lihat Dokumentasi
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="mb-5 card card-bordered">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="gap-2 d-flex align-items-center">
                                    <select id="articlesSelectAdd" class="form-select form-select-sm" multiple="multiple">
                                        @foreach ($articles as $article)
                                            <option value="{{ $article->id }}">{{ $article->title }}</option>
                                        @endforeach
                                    </select>
                                    <button onclick="addArticlesToIndikator()" class="btn btn-sm btn-light-success">Tambah</button>
                                </div>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <div class="mb-5 card card-bordered">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="gap-2 d-flex align-items-center">
                                    <select id="forumsSelectAdd" class="form-select form-select-sm" multiple="multiple">
                                        @foreach ($forums as $forum)
                                            <option value="{{ $forum->id }}">{{ $forum->title }}</option>
                                        @endforeach
                                    </select>
                                    <button onclick="addForumsToIndikator()" class="btn btn-sm btn-light-primary">Tambah</button>
                                </div>
                            </div>
                            <div class="card-body">
