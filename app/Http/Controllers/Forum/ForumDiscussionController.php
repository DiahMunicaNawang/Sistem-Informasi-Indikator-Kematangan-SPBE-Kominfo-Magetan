...
use App\Http\Requests\Forum\ForumDiscussionRequest;
use App\Models\Forum\ForumDiscussion;
use App\Services\Forum\ForumDiscussionService;
...
class ForumDiscussionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('forum.forum-discussion-index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('forum.forum-discussion-create', $data);
    }
    ...
    public function show($id)
    {
        ...
        return view('forum.forum-discussion-show', $data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('forum.forum-discussion-edit', $data);
    }
    ...
    public function forum_discussion_approval_rejected() {
        ...
        return view('forum.forum-discussion-approval-rejected', $data);
    }

    public function forum_discussion_approval_accept($id) {
        $data = $this->forumDiscussionService->forumDiscussionApprovalAccept($id);
        return view('forum.forum-discussion-approval-accept-availability', $data);
    }
    ...
    public function forum_discussion_approval_accepted() {
        ...
        return view('forum.forum-discussion-approval-accepted', $data);
    }
